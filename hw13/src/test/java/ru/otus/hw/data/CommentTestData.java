...
public class CommentTestData {
    ...
    public static Map<Long, List<Comment>> getDbMapBooksComments() {
        ...
        dbMapBooksComments.put(book1.getId(), List.of(
                new Comment(1L, "comment_1", book1, "reader"),
                new Comment(2L, "comment_2", book1, "reader"),
                new Comment(3L, "comment_3", book1, "admin")));
        Book book2 = DB_BOOKS.get(1);
        dbMapBooksComments.put(book2.getId(), List.of(
                new Comment(4L, "comment_4", book2, "reader"),
                new Comment(5L, "comment_5", book2, "admin"),
                new Comment(6L, "comment_6", book2, "reader")));
    ...
    public static Comment getNewComment() {
        return new Comment(7L, "new_comment", DB_BOOKS.get(2), "admin");
    }

    public static Comment getChangeComment() {
        return new Comment(1L, "change_comment", DB_BOOKS.get(2), "admin");
    }
}
